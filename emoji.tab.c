...
{
      12,     0,    -1,    -1,    12,    13,    -1,     3,    -1,     3,
       9,    -1,     3,    10,    -1,     4,    -1,     5,    -1,     6,
      -1,     7,    -1,     8,    -1
};
...
{
  "$end", "error", "$undefined", "EMOJI_WORD", "REGULAR_WORD",
  "WHITESPACE", "NEWLINE", "PUNCTUATION", "OTHER_CHAR", "EXCLAMATION",
  "QUESTION", "$accept", "document", "text_element", 0
};
#endif
